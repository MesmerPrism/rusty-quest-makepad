# Rusty Quest Makepad Agent Runbooks

Use this folder as the second-hop instruction surface after the root
`AGENTS.md`. Open only the runbook that matches the current task.
...
- `recorded-hand-particles.md`: local recorded full hand-mesh replay,
  ...
  rules.
- `adf-gpu-evidence.md`: ADF/field-force ownership, GPU proof marker
  checklists, storage/readback evidence, and force-authority promotion gates.
